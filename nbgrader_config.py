...
# server set up.
c.CourseDirectory.course_id = "stat-301"

# Update this list with other assignments you want
c.CourseDirectory.db_assignments = [
    dict(name="worksheet_01"),
    dict(name="tutorial_01"),
    dict(name="worksheet_02"),
    dict(name="tutorial_02"),
    dict(name="worksheet_03"),
    dict(name="tutorial_03"),
    dict(name="worksheet_04"),
    dict(name="tutorial_04"),
    dict(name="worksheet_05"),
    dict(name="worksheet_06"),
    dict(name="tutorial_06"),
    dict(name="worksheet_07"),
    dict(name="tutorial_07"),
    dict(name="worksheet_08"),
    dict(name="worksheet_09"),
    dict(name="tutorial_09"),
    dict(name="worksheet_10"),
    dict(name="tutorial_10"),
    dict(name="worksheet_11"),
    dict(name="tutorial_11")]
...
c.ClearSolutions.text_stub = 'DOUBLE CLICK TO EDIT **THIS CELL** AND REPLACE THIS TEXT WITH YOUR ANSWER.'
